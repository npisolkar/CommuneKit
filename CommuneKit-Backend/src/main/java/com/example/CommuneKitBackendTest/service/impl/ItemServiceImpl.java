...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public List<ItemDto> searchItems(String keyword, String category) {
        List<Item> items;

        if (keyword != null && category != null) {
            items = itemRepository.searchByKeywordAndCategory(keyword, category);
        }
        else if (keyword != null) {
            items = itemRepository.searchByKeyword(keyword);
        }
        else if (category != null) {
            items = itemRepository.findByItemCategory(category);
        }
        else {
